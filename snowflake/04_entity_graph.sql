...
ALTER TAG CRYPTO_SURVEILLANCE.HARMONISED.PII SET ALLOWED_VALUES 'name', 'email', 'phone', 'dob', 'address', 'tax_id';
...
ALTER TAG CRYPTO_SURVEILLANCE.HARMONISED.DATA_SENSITIVITY SET ALLOWED_VALUES 'PUBLIC', 'INTERNAL', 'CONFIDENTIAL', 'RESTRICTED';
...
ALTER TAG CRYPTO_SURVEILLANCE.HARMONISED.REGULATORY SET ALLOWED_VALUES 'KYC', 'AML', 'SAR', 'GDPR', 'MiFID2', 'FATF';
