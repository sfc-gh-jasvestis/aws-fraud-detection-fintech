...
class SnowflakeConfig:
    account:   str = field(default_factory=lambda: _env("SURV_SF_ACCOUNT",   "<YOUR_CONNECTION>"))
...
class AWSConfig:
    ...
    account_id:  str = field(default_factory=lambda: _env("AWS_ACCOUNT_ID",     "__AWS_ACCOUNT_ID__"))
